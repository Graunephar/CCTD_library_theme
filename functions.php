...
<li <?php comment_class(); ?> id="comment-<?php comment_ID() ?>">
	...
	<div class="comment-wrap">
		...
		<div class="comment-body">
			...
			<?php if ($comment->comment_approved == '0') { ?><em><i class="fa fa-spinner fa-spin" aria-hidden="true"></i> <?php _e('Comment awaiting approval', 'cctd'); ?></em><br /><?php } ?>
			<?php comment_text(); ?>
			<span class="comment-reply"> <?php comment_reply_link(array_merge( $args, array('reply_text' => __('Reply', 'cctd'), 'depth' => $depth, 'max_depth' => $args['max_depth'])), $comment->comment_ID); ?></span>
		</div>
	</div>
	<?php }
	...
	add_action('wp_enqueue_scripts', 'cctd_public_styles');

	function cctd_public_styles() {
